...
| --- | --- | --- | --- |
| `mvp-zurich/` | KB1, the MVP: federal sources plus Canton of Zurich and City of Zurich; extended on 15 September 2026 with the moving-to-Switzerland topics (social insurance on arrival and departure, tax at source, the foreign driving licence, health insurance and premium reduction) and naturalisation, at the same three levels, on 17 September 2026 with the contact pages of the Zurich offices these topics name, with daily life in the City of Zurich (waste, parking, vehicles, dogs, kindergarten, the tax return, the radio and television fee, medical emergencies) and with entry and visas, and on 18 September 2026 with voting rights, the tax-at-source tariff and the expat-life topics (family allowances and parental leave, renting a home, marriage, leaving the City of Zurich, pillar 3a, unemployment, accident insurance, customs on moving), and on 19 September 2026 with the English versions of 24 cited federal pages (SEM, FOPH, FOCBS, SECO, SERAFE) next to the German ones, and on 22 September 2026 with the five-year routes to the settlement permit that rest on settlement agreements and, the same day, with twenty concepts curated from pages the catalogue already held (social security agreements, the third generation in naturalisation, the City of Zurich's German and civic-knowledge tests and its city citizenship, three Zurich family-reunification routes, the permit cards, third-country labour-market admission federally and in Zurich, the cantonal permit card, the entry permits for retirees and close relatives, travel documents and waste sorting), with the first citations of the BüG, BüV, VZAE, KVG and DBG, and on 22 and 23 September 2026 with the integration offers of the Canton of Zurich and with customs (the value-free limit and the duty-free quantities when travelling, declaring goods, ordering from abroad with the mail-order and platform rules, returns and repairs, pets and plants, moving household goods and a vehicle, and taking goods out of Switzerland), from the pages of the Federal Office for Customs and Border Security, and on 23 September 2026 with basic health insurance (what the insured pays themselves, the models with a restricted choice of provider, the premium regions and how premiums are approved, arrears, the benefits and the dental exception, changing insurer, cross-border commuters, treatment abroad, people insured while living abroad, who is billed for a treatment, and suspending the insurance during long service), from the pages of the Federal Office of Public Health and the plain-language premium portal, with the KVG, the KVV and the KLV cited beside them, and, the same day, with work and unemployment (signing on with the RAV and an unemployment fund, the duty to look for work and the proof of it, the waiting days and the daily allowances, interim earnings, insolvency compensation with the cantonal deadline, the labour-market measures, the end of the entitlement, contribution periods and the portable documents U1 and U2 in the EU and EFTA, short-time work, the job-registration duty, and the notice periods and the work reference of the Code of Obligations), from the pages of SECO through arbeit.swiss and of the Canton of Zurich's Office for the Economy, and, the same day, with the AHV, the pillar system and retirement (who is insured and who owes contributions, the individual account and the gaps in it, the reference age and drawing a pension early or late, claiming it, the thirteenth pension, survivors' pensions, the coordination with the EU, EFTA and third states, and a map of the three pillars and the other branches), from the pages of the AHV/IV information service and of SVA Zurich, and, the same day, with registering on arrival in **all 26 cantons** (the period a canton gives and the duty it attaches to, the office that receives the report, how the permit is applied for, what a change of canton requires and any online channel), from each canton's own service pages and, where only the law states the period, from its systematic collection of law | 251 (55 federal, 29 cantonal Zurich, 12 municipal, 155 cantonal outside Zurich): the 35 of the rehearsal, 25 of the topic extension, 8 of the office contacts, 10 of daily life, 2 of entry and visas, 4 of voting rights, 12 of expat life and the 71 of the `cantonal` scan set covering 25 cantons, plus 173 explicit pages in `sources.md` (the extensions' seeds and their subpages, and the English versions) | Catalogue `draft-12`, saved in the local run (five pages answer HTTP 404, the Fedlex pages added since 17 September are application shells whose dated documents are saved, and Jura's statute is not catalogued because its collection addresses documents with a query string); the built release `mvp-zurich-2026-09-23-v27` (20 topics, 211 concepts, 1,268 facts, 1,526 excerpts of which 114 English, and the place register of all Swiss cantons and municipalities, so that a caller names a place instead of its code) is built and validated, passes its acceptance suite (UAT-1 to UAT-116 and the decline cases, 138 cases with none failing) and its regression pack lexically and in hybrid mode (`regression-report.json`, 660 and 656 of 702 with no blocking failure and 66 quarantined), and carries a rebuilt semantic index of 211 concepts; it is **attested**, so `readiness.json` names `mvp-zurich-2026-09-23-v27`, attested on 23 September 2026 with all six readiness gates passed, superseding `mvp-zurich-2026-09-23-v19`; every concept has authored everyday aliases and at least one sample question in English and one in German, which the build checks; all 1,268 facts are reviewed by one person (confirmed in the console, most in bulk groups; the first 253 also read card by card on 15 September; the 113 customs, 98 health insurance, 131 work and unemployment and 90 AHV facts on 23 September 2026, each hardest first against a written brief, and the 124 cantonal registration facts the same day against two briefs with an English rendering beside each French and Italian excerpt), the 114 English excerpts added on 19 September are not; the published image and GitHub release are named in the pack's `README.md`; its contents and review status are in [COVERAGE.md](../COVERAGE.md) and [LIMITATIONS.md](../LIMITATIONS.md) |
| `mvp-wallisellen/` (proof of concept, outside the hackathon submission; frozen at its attested release) | Multi-topic municipal MVP: stable resident-facing information published by Stadt Wallisellen | 10 registry entries and 55 explicit catalogue targets: 50 pages and the five waste PDFs linked from the waste disposal page | All 55 targets saved with no gaps; 54 extracted, the collection-area map PDF has no text layer (no OCR); release `mvp-wallisellen-2026-09-18-v1` (the facts of `mvp-wallisellen-2026-09-16-v3` with the place register added, attested again on 18 September 2026 and, after a change to one answer pattern of its suite, on 19 September 2026) with 99 assistant-authored facts across 30 concepts and 10 topics, including the 2026 collection dates by area, fee bags, bulky-waste stamps and set-out rules; a registry of six city institutions and the basis of every excerpt (76 municipal guidance, 23 municipal directory), assigned by assistant subagents with the pipeline's basis prompt and listed in [basis-review.md](mvp-wallisellen/basis-review.md); every fact, institution and basis confirmed by one person on 16 September 2026, who attested the release; built, thoroughly validated, passing the forty-one cases of its acceptance suite, with a rebuilt semantic index and an attested readiness record; the [acceptance questions](../docs/product/wallisellen-user-acceptance-tests.md) were also run through the OpenCode harness |
